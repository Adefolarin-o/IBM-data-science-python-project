...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # If ALL sites are selected, use all rows to render a pie chart for total success launches
        ...
        # Group by class to get success (1) and failure (0) counts
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        # If ALL sites are selected, render a scatter plot for all values
